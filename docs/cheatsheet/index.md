...
| --- | --- | --- | --- | --- | --- |
| `generation-scheduling.md` | 生成枠・取消/Close・2曲先読み・genre epoch・cache/token保護（実装前事実と実装後as-built） | Irodori v4.1 対応版 / WP-1〜3 / Windows / Go 1.26.1 | 2026-09-12 | ローカルコード確認 + 独立受入/最終テスト・ビルド | 音楽とTTSの排他、先読み、ジャンル変更、cache整理、音声URL保護を変更・再確認するとき |
...
| `domain_primer.md` | ローカル音声合成の入力・品質・速度・計算graphの基本 | ローカルTTS/ラジオ | 2026-09-12 | ドメイン説明 + 調査で確認した不変条件 | TTS移行要件やE2Eを作る前 |
